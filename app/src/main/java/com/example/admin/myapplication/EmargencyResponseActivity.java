...
public class EmargencyResponseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       timer= new CountDownTimer(5000, 1000) {
        ...
        CardView ambulance = (CardView) (findViewById(R.id.call_ambulance));
        ...
        CardView hospital = (CardView) (findViewById(R.id.call_hospital));
        ...
        CardView police = (CardView) (findViewById(R.id.call_police));
