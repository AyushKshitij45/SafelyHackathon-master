...
getData();
        disease.add(new List("Name", R.drawable.name,name));
        disease.add(new List("Emergency contact", R.drawable.emergency_contact,number1));
        disease.add(new List("Blood Group", R.drawable.blood,blood));
        disease.add(new List("Email", R.drawable.email,email));
        disease.add(new List("BP Status", R.drawable.bp,b_p));
        disease.add(new List("Diabetes", R.drawable.diabetes,diab));
